...
public class DatabaseService(string connectionString) : IDatabaseService
{
    ...
    /// </summary>
    [KernelFunction]
    [Description("Get bookings by hotel for a starting date.")]
    ...
    [KernelFunction]
    [Description("Get bookings without associated hotel rooms.")]
    ...
    [KernelFunction]
    [Description("Get bookings with more than one hotel room.")]
